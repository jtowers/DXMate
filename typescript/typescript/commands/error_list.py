...
from ..libs.view_helpers import active_view, get_info, is_apex, active_view
...
class TypescriptProjectErrorList(sublime_plugin.WindowCommand):
    ...
    def is_enabled(self):
        return is_apex(active_view()) and not global_vars.IS_ST2 and global_vars.get_language_service_enabled()
